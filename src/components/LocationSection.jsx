...
export default function LocationSection() {
  const address = "Cbd Ground, opposite unity one mall, Vishwas Nagar Extension, Vishwas Nagar, Shahdara, Delhi, 110032";
  const googleMapsUrl = "https://www.google.com/maps/dir//Grand+Amara+Banquets-+Group+Gurmeet,+Cbd+Ground,+opposite+unity+one+mall,+Vishwas+Nagar+Extension,+Vishwas+Nagar,+Shahdara,+Delhi,+110032/@28.6544422,77.2658448,14z/data=!4m9!4m8!1m0!1m5!1m1!1s0x390cfbdb60faf6bd:0xfb3095fe4c5cbd9f!2m2!1d77.2983312!2d28.660879!3e0?entry=ttu&g_ep=EgoyMDI2MDkxNi4wIKXMDSoASAFQAw%3D%3D";
    ...
    <section className="relative w-full bg-[#F9F0E0] py-16 px-4 flex flex-col items-center justify-center text-center">
      ...
      <ScrollReveal animation="fade-up" delay={300} className="max-w-md space-y-3 px-4">
        <h3 className="font-serifCustom text-[24px] sm:text-[30px] text-[#846f61] font-semibold">
          Grand Amara Banquets CLUB X - Group Gurmeet
        </h3>
